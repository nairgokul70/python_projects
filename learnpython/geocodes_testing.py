...
with open('C:\Users\gokul.nair\Desktop\Excel\input\geocodes_customer.csv') as geocodes_csv:
     ...
     for row1,row2,row3 in reader:
         ...
         with open('C:\Users\gokul.nair\Desktop\Excel\output\geocodes.csv','a') as geocodes_output:
